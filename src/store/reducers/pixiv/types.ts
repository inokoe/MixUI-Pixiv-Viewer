...
export interface rankMark extends Pick<PixivRankParams, 'size' | 'page' | 'date'> {
  illusts: Illust[]
}

export interface rankDataPayload extends rankMark, Pick<PixivRankParams, 'mode' | 'type'> {}
...
// 搜索模式类型
export type SearchModeType = 'partial_match_for_tags' | 'exact_match_for_tags' | 'title_and_caption'

// 搜索排序类型
export type SearchSortType = 'date_desc' | 'date_asc' | 'popular_desc'

// 搜索时间范围类型
export type SearchDurationType = 'within_last_day' | 'within_last_week' | 'within_last_month'
