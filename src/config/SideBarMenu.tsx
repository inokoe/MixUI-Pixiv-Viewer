...
const links = [
  {
    ...
    href: '/',
    icon: (
      <IconPhoto className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
    ),
  },
  {
    id: 2,
  ...
  },
  {
    ...
    href: '/about',
    icon: (
      <IconBrandGit className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
    ),
  },
];
